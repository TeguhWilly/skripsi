...
$sql = "select id_tes,id_user,nama_pelajaran as mata_pelajaran,nama_tes,nama as nama_siswa,nilai plagiat from v_nilai_tes_per_siswa where id_tes ='".$id_tes."'";
}
else {
// ambil semua nilai tes_uraian yang telah dikerjakan oleh siswa ini
$sql = "select id_tes,nama_pelajaran,nama_tes,nilai plagiat from v_nilai_tes_per_siswa where id_user ='".$id_user."'";
}
...
if($jumlahBaris > 0){
	...
	echo "<caption>Daftar Nilai Plagiat</caption>";
	// buat header
